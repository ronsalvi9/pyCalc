...
f = Frame(root, bg="grey")
b = Button(f, text="0", padx=30.25, pady=18, font="lucida 35 bold")
b.bind("<Button-1>", click)
b.pack(side=LEFT, padx=18, pady=5)
b = Button(f, text="-", padx=30.25, pady=18, font="lucida 35 bold")
b.bind("<Button-1>", click)
b.pack(side=LEFT, padx=18, pady=5)
b = Button(f, text="*", padx=30.25, pady=18, font="lucida 35 bold")
b.bind("<Button-1>", click)
...
f = Frame(root, bg="grey")
b = Button(f, text="/", padx=28.5, pady=18, font="lucida 35 bold")
b.bind("<Button-1>", click)
b.pack(side=LEFT, padx=18, pady=5)
b = Button(f, text="%", padx=28.5, pady=18, font="lucida 35 bold")
b.bind("<Button-1>", click)
